(function() {
  ...
  MM.Entry = (function(_super) {
    ...
    Entry.prototype.hasWorkflow = function() {
      return this.workflow instanceof MM.Workflow;
    };

    Entry.prototype.hasState = function() {};

    Entry.prototype.initializeWorkflow = function() {
      console.log(this, 'initializeWorkflow', this.get('wf_id'));
      this.workflow = MM.workflows.get(this.get('wf_id'));
      if (this.hasWorkflow()) {
        return this.set({
          workflow_label: this.workflow.get('label')
        });
      }
    };
